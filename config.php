...
// ----------------------------------------------------------------------
$ZConfig['DBInfo']['databases']['default']['host'] = 'mysql5.service';
$ZConfig['DBInfo']['databases']['default']['user'] = 'HTO01FLQXFMA';
$ZConfig['DBInfo']['databases']['default']['password'] = 'MHdC_Ärger4';
$ZConfig['DBInfo']['databases']['default']['dbname'] = 'HTO01FLQXFMA';
